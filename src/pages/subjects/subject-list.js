      ...
      <Row gutter={80}>
        <Col className="subject-list-left" span={10}>
          ...
          <p>
            ...
            maxoratini shakillantirish. Dasturlash tilining tarkibiy qismlari:
            Operator, funksiya, massiv, ko’rsatgich, sinf va shablonlar tuzish
            va ulardan foydalanish usullari mukammal o’rgatiladi. Talabalar
            kichik muammoli holatlarni algoritmini tuzishda obyektga
            yo’naltirilgan dasturlashning yangi imkoniytalaridan foydalangan
            holda qaror qabul qilishni, amaliy va zamonaviy ilovalarni yaratish
            texnologiyalarini o'rganadi.
          </p>
          <div>
            <h2>Talabalar</h2>
